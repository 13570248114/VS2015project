...
private:
  ...
  std::shared_ptr<Asset> retrieveAsset();
  std::shared_ptr<Asset> retrieveAssetBySerial();
  void custodianDetails(std::shared_ptr<Asset> asset);
  void maintenanceDetail(std::shared_ptr<Asset> asset);
  std::shared_ptr<Asset> findMenu();
  void displayAsset(std::shared_ptr<Asset> asset);
