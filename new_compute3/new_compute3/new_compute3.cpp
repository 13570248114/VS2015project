...
void computer_pre(int star, int Limit_num_nodes, PointUnionLists List, int numOfSpecialVer, isRound isRoundPoint, int isRoundNum)    //计算pre矩阵，star为起点,Limit_num_nodes为限制的节点数，table1位邻接表
{
	//////////////////////////////////////初始化工作
...
int isInTheSpecialVertexList(int x, int* specialVertex, int numOfSpecialVer)    //判断是否在必经点的序列内，是的话则返回其标号
{
